                    ...
                    <div class="row">
                      <div class="col-auto">
                        <nav>
                          ...
                          <div class="tab-pane fade show active pt-3" id="nav-home" role="tabpanel" aria-labelledby="nav-home-tab">간결한 디자인의 싱글 레더 자켓 제품입니다. <br><br>리얼레더의 질감, 자연스럽게 떨어지는 매력적인 제품입니다. <br><br>간결한 디테일들로 고급스러운 데일리 연출이 가능합니다. <br>- 투웨이 집업 디테일, 니켈 흑무광 부자재 사용 <br>- 속주머니 디테일, 소매 2단 스냅, 밑단 벨트 길이 조절 <br><br>[color] <br>블랙 <br><br>[Fabric] <br>PU 45%, Payon 55% <br><br>[Model] <br>171cm 62kg / M size 착용</div>
                          <div class="tab-pane fade pt-3" id="nav-profile" role="tabpanel" aria-labelledby="nav-profile-tab">M – 어깨 59 / 가슴 60.5 / 소매 57 / 총장 67 <br>L – 어깨 60.5 / 가슴 61.5 / 소매 58 / 총장 68.5 <br>제품 측정에 따라 1-3cm 차이가 있을 수 있습니다.</div>
