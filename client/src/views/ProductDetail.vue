                    ...
                    <div class="row">
                      <div class="col-auto">
                        <nav>
                          ...
                          <div class="tab-pane fade pt-3" style="white-space: pre-line;" id="nav-profile" role="tabpanel" aria-labelledby="nav-profile-tab">{{productDetail.product_sizeGuide}} <br>제품 측정에 따라 1-3cm 차이가 있을 수 있습니다.</div>
